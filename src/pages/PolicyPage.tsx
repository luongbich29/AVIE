...
export default function PolicyPage() {
  ...
  return (
    <div className="bg-background text-on-surface min-h-screen flex flex-col font-sans relative antialiased select-none">
      ...
      {/* Main Content Area */}
      <main className="flex-grow max-w-screen-xl mx-auto w-full pb-28">
        {/* Hero Section */}
        ...
        <section className="px-container-padding -mt-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <div className="bg-surface p-4 border border-outline-variant flex flex-col items-center justify-center text-center shadow-sm">
              <span className="material-symbols-outlined text-secondary text-[32px] mb-2">restart_alt</span>
              <span className="font-label-md text-[11px] text-on-surface uppercase tracking-wider font-semibold">
                7 Ngày Đổi Trả
              </span>
            </div>
            <div className="bg-surface p-4 border border-outline-variant flex flex-col items-center justify-center text-center shadow-sm">
          ...
          <div className="space-y-0 relative pl-2">
            ...
            <div className="flex gap-4">
              <div className="flex flex-col items-center shrink-0">
                <div className="w-8 h-8 rounded-full bg-primary text-white flex items-center justify-center font-label-md z-10 font-bold">
                  1
                </div>
                <div className="w-[1px] flex-grow bg-outline-variant/50 min-h-[140px]" />
              </div>
              <div className="pb-8 pt-1 flex-grow">
                <h4 className="font-body-lg font-bold text-on-surface mb-1 uppercase tracking-wider">
                  Kiểm tra điều kiện
                </h4>
                ...
                <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-2 max-w-lg">
                  ...
                  <div className="bg-surface-container-high p-3 flex items-center rounded border border-outline-variant/30">
                    <span className="font-label-md text-on-surface-variant italic leading-relaxed text-[11px]">
                      Giữ lại hóa đơn và bao bì gốc để được hỗ trợ tốt nhất.
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="flex gap-4">
              <div className="flex flex-col items-center shrink-0">
                ...
                <div className="w-[1px] flex-grow bg-outline-variant/50 min-h-[90px]" />
              </div>
              <div className="pb-8 pt-1 flex-grow">
                <h4 className="font-body-lg font-bold text-on-surface mb-1 uppercase tracking-wider">
                  Đăng ký đổi trả
                ...
                <div className="mt-4">
                  <button
                    ...
                    className="bg-primary text-white font-label-md text-label-md px-6 py-3 uppercase tracking-widest hover:bg-primary/95 transition-all active:scale-95 rounded font-bold"
                  >
                    Liên hệ ngay
                  </button>
                </div>
        ...
        <section className="px-container-padding mt-section-gap">
          <div className="bg-primary text-white p-6 relative overflow-hidden rounded-lg shadow-sm">
            {/* Background Icon Shield Backdrop */}
            <div className="absolute right-[-20px] top-[-20px] opacity-10 pointer-events-none">
              <span className="material-symbols-outlined text-[130px]">shield</span>
            </div>

            <h3 className="font-headline-md text-headline-md mb-5 relative z-10 font-bold">Chính sách Bảo hành</h3>
        ...
        <section className="px-container-padding mt-section-gap">
          ...
          <div className="space-y-3 max-w-3xl">
            <details className="group bg-surface border border-outline-variant rounded transition-all duration-200">
              <summary className="flex justify-between items-center p-4 cursor-pointer font-body-md font-bold uppercase tracking-tight list-none outline-none select-none">
              ...
              <div className="px-4 pb-4 font-body-md text-on-surface-variant border-t border-outline-variant/30 pt-3 leading-relaxed">
                Sản phẩm giảm giá trên 30% sẽ không áp dụng đổi trả trừ trường hợp lỗi từ nhà sản xuất. Vui lòng kiểm
                tra kỹ bảng size trước khi mua.
              </div>
            </details>
            <details className="group bg-surface border border-outline-variant rounded transition-all duration-200">
              <summary className="flex justify-between items-center p-4 cursor-pointer font-body-md font-bold uppercase tracking-tight list-none outline-none select-none">
              ...
              <div className="px-4 pb-4 font-body-md text-on-surface-variant border-t border-outline-variant/30 pt-3 leading-relaxed">
                Có, bạn có thể đổi sang sản phẩm có giá trị bằng hoặc cao hơn (vui lòng bù chênh lệch). Nếu thấp hơn,
                AoVie không hoàn lại tiền thừa.
              </div>
            </details>
          </div>
        </section>
